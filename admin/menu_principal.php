...
=======
// BLOQUE DE SEGURIDAD (Comentado temporalmente para pruebas de maquetación)
// =========================================================================
/*
session_start();
// Si no hay una sesión activa, expulsar al index (Login)
...
=======
    ...
    <style>
        body { 
            ...
            display: flex; 
            flex-direction: column; 
            background-color: #f4f6f9; /* Tono suave para la vista central */
        }
        /* Estilos del Menú Lateral (Sidebar) */
        .sidebar { 
            min-height: 100vh; 
            background-color: #1a1e21; /* Gris oscuro elegante para Soundverse */
            color: white; 
            box-shadow: 2px 0 5px rgba(0,0,0,0.1);
        }
        .sidebar a { 
        ...
        <div class="row g-0">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="logo-container">
                    <img src="../assets/img/logo_principal.png" alt="Soundverse Logo" class="img-fluid px-3"
    ...
    <div class="row g-0">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-4">
            ...
            <div id="contenedor-vistas">
                ...
                <div class="alert alert-primary shadow-sm border-0 border-start border-5 border-primary">
                    <h4 class="alert-heading"><i class="fas fa-info-circle"></i> Bienvenido a Soundverse</h4>
                    <p>El sistema está funcionando correctamente. Selecciona un módulo en el menú lateral izquierdo para comenzar a administrar la plataforma.</p>
                </div>
