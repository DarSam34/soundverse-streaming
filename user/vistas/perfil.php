...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="text-dark fw-bold mb-0"><i class="fas fa-user-circle me-2 text-primary"></i><span
                    data-key="nav_perfil">Mi Perfil</span></h2>
            <p class="text-secondary" data-key="prf_subtitulo">Gestiona tu información personal y seguridad de tu
                cuenta.</p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <div class="card bg-dark text-light border-secondary h-100 shadow-sm"
                style="border-radius: 12px; background: linear-gradient(145deg, #1a1a1a, #121212) !important;">
                <div class="card-header border-secondary bg-transparent pb-0 pt-3">
                    <h5 class="mb-0 text-light"><i class="fas fa-user-edit me-2 text-primary"></i><span
                            data-key="prf_datos">Datos Personales</span></h5>
                </div>
                <div class="card-body">
                    <form id="form-perfil">
                        <div class="mb-3">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="registro_nombre">Nombre Completo</label>
                            <input type="text" class="form-control bg-dark border-secondary px-3 py-2"
                                id="perfil-nombre" required minlength="3"
                                style="border-radius: 8px; color: #ffffff !important;">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="login_correo">Correo Electrónico</label>
                            <input type="email" class="form-control bg-dark border-secondary px-3 py-2"
                                id="perfil-email" required style="border-radius: 8px; color: #ffffff !important;">
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="prf_nivel">Nivel de Suscripción</label>
                            <input type="text" class="form-control bg-dark border-secondary px-3 py-2" id="perfil-tipo"
                                readonly disabled style="border-radius: 8px; color: #fff; font-weight: bold;">
                            <small class="text-light mt-2 d-block" style="opacity:0.6;"><i
                                    class="fas fa-info-circle me-1"></i><span data-key="prf_mejorar">Para mejorar tu
                                    cuenta, ve a la sección Premium.</span></small>
                        </div>
                        <button type="submit" class="btn btn-primary w-100 rounded-pill fw-bold py-2 shadow"><i
                                class="fas fa-save me-2"></i><span data-key="btn_guardar">Guardar
                                Cambios</span></button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card bg-dark text-light border-secondary h-100 shadow-sm"
                ...
                <div class="card-header border-secondary bg-transparent pb-0 pt-3">
                    <h5 class="mb-0 text-light"><i class="fas fa-lock me-2 text-warning"></i><span
                            data-key="prf_seguridad">Seguridad</span></h5>
                </div>
                <div class="card-body">
                    <form id="form-password">
                        <div class="mb-3">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="prf_pass_actual">Contraseña Actual</label>
                            <input type="password" class="form-control bg-dark border-secondary px-3 py-2"
                                id="pass-antigua" required style="border-radius: 8px; color: #ffffff !important;">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="prf_pass_nueva">Nueva Contraseña</label>
                            <input type="password" class="form-control bg-dark border-secondary px-3 py-2"
                                id="pass-nueva" required minlength="8"
                                style="border-radius: 8px; color: #ffffff !important;">
                            <small class="text-light" style="opacity:0.6;"><i
                                    class="fas fa-shield-alt me-1 text-success"></i><span data-key="prf_pass_hint">Debe
                                    contener 8 caracteres, números y mayúsculas.</span></small>
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-light small text-uppercase fw-bold" style="opacity:0.8;"
                                data-key="registro_contrasena2">Confirmar Nueva Contraseña</label>
                            <input type="password" class="form-control bg-dark border-secondary px-3 py-2"
                                id="pass-confirm" required minlength="8"
                                style="border-radius: 8px; color: #ffffff !important;">
                        </div>
                        <button type="submit"
                            class="btn border-warning text-warning w-100 rounded-pill fw-bold py-2 btn-outline-warning shadow-sm"><i
                                class="fas fa-key me-2"></i><span data-key="prf_pass_btn">Actualizar
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card bg-dark text-light border-secondary shadow-sm"
                style="border-radius: 12px; background: linear-gradient(145deg, #121212, #1a1a1a) !important;">
                <div class="card-header border-secondary bg-transparent pb-0 pt-3">
                    <h5 class="mb-0 text-light"><i class="fas fa-heart me-2 text-danger"></i>Artistas a los que sigo
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row" id="lista-artistas-seguidos">
                        <div class="col-12 text-center py-4 text-light border border-secondary rounded"
                            style="border-style: dashed !important; color: white !important;">
