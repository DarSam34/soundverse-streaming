...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs mb-4" id="catalogoTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active fw-bold text-dark" id="albumes-tab" data-bs-toggle="tab"
                data-bs-target="#albumes" type="button" role="tab" aria-controls="albumes" aria-selected="true"
                onclick="cargarAlbumes()">
                <i class="fas fa-compact-disc me-1 text-primary"></i> Álbumes
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link fw-bold text-dark" id="canciones-tab" data-bs-toggle="tab"
                data-bs-target="#canciones" type="button" role="tab" aria-controls="canciones" aria-selected="false"
                onclick="cargarTodasCanciones()">
    ...
    <div class="tab-content" id="catalogoTabsContent">
        ...
        <div class="tab-pane fade" id="canciones" role="tabpanel" aria-labelledby="canciones-tab">
            <div class="row mb-3 align-items-center">
                <div class="col-md-8">
                    <input type="text" id="buscador-todas-canciones" class="form-control"
                        placeholder="Buscar por título, artista o álbum..." onkeyup="filtrarTodasCanciones()">
                </div>
                <div class="col-md-4 text-end">
                    <button class="btn btn-primary rounded-pill fw-bold shadow-sm w-100 mt-2 mt-md-0"
                        onclick="reproducirGlobal()">
