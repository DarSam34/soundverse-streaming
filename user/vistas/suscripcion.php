...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12 text-center">
            <h2 class="text-dark fw-bold mb-0 text-uppercase"><i class="fas fa-crown me-2 text-warning"></i><span
                    data-key="sub_titulo">Suscripción Premium</span></h2>
            <p class="text-secondary" data-key="sub_subtitulo">Descubre la música sin límites y apoya a tus artistas
                favoritos.</p>
        </div>
    </div>
    ...
    <div id="seccion-upgrade" class="row justify-content-center mb-5" style="display:none;">
        <div class="col-md-8 col-lg-6">
            <div class="card bg-dark text-light border-warning shadow-lg"
                style="border-radius: 12px; background: linear-gradient(145deg, #121212, #2b1d03) !important;">
                <div class="card-body p-5 text-center">
                    ...
                    <ul class="list-unstyled text-start mx-auto mb-4" style="max-width: 300px;">
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i><span
                                data-key="sub_feat_1">Música sin anuncios</span></li>
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i><span
                                data-key="sub_feat_2">Saltos de canción ilimitados</span></li>
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i><span
                                data-key="sub_feat_3">Calidad de audio Máxima (320kbps)</span></li>
                        <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i><span
                                data-key="sub_feat_4">Playlists ilimitadas</span></li>
                    </ul>

                    <h4 class="mb-4 text-light"><strong>$ 149.00</strong> <small class="text-muted" data-key="sub_mes">/
                            mes</small></h4>

                    <form id="form-upgrade">
                        <select class="form-select bg-black text-light border-secondary mb-3 w-75 mx-auto"
                            id="select-metodo" required>
                            <option value="" data-key="sub_select_pago">Selecciona Método de Pago...</option>
                        </select>
                        <button type="submit"
                            class="btn btn-warning w-75 rounded-pill fw-bold py-3 text-dark fs-5 shadow-sm">
    ...
    <div id="seccion-activa" class="row justify-content-center mb-5" style="display:none;">
        <div class="col-md-8 text-center">
            <div class="alert bg-dark border-warning text-light py-4 shadow-sm" style="border-radius: 12px;">
                <h3 class="text-warning mb-3"><i class="fas fa-star me-2"></i><span data-key="sub_miembro">¡Eres miembro
                        Premium!</span></h3>
                <p class="mb-0 text-secondary" data-key="sub_beneficios">Estás disfrutando de Soundverse con todos los
                    beneficios desbloqueados.</p>
                <div class="mt-4 pt-3 border-top border-secondary">
                    <button class="btn btn-outline-warning rounded-pill px-4 me-2"><span data-key="sub_btn_cambiar_pago"
                            onclick="cambiarMetodoPago()">Cambiar Método de Pago</span></button>
                    <button class="btn btn-outline-danger rounded-pill px-4"><span data-key="sub_btn_cancelar"
                            onclick="cancelarSuscripcion()">Cancelar Suscripción</span></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <h4 class="text-dark mb-3"><i class="fas fa-file-invoice-dollar me-2 text-secondary"></i><span
                    data-key="sub_historial">Historial de Facturación</span></h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-dark table-hover mb-0 align-middle">
                            <thead class="border-secondary">
                                <tr>
                                    <th class="ps-4 fw-bold text-secondary text-uppercase small"
                                        data-key="sub_th_factura">Nº Factura</th>
                                    <th class="fw-bold text-secondary text-uppercase small" data-key="sub_th_fecha">
                                        Fecha</th>
                                    <th class="fw-bold text-secondary text-uppercase small" data-key="sub_th_plan">Plan
                                    </th>
                                    <th class="fw-bold text-secondary text-uppercase small" data-key="sub_th_metodo">
                                        Método de Pago</th>
                                    <th class="fw-bold text-secondary text-uppercase small text-end pe-4"
                                        data-key="sub_th_total">Total</th>
                                </tr>
                            </thead>
                            <tbody id="tabla-facturas">
                                <tr>
                                    <td colspan="5" class="text-center py-4"><i
                                            class="fas fa-spinner fa-spin text-warning fs-3"></i></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
