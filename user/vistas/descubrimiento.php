...
<div class="container-fluid fade-in">
    ...
    <div class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="fw-bold text-dark mb-0">
                <i class="fas fa-heart me-2 text-danger"></i> <span data-key="ds_basado_gustos">Basado en tus
                    gustos</span>
            </h4>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="text-primary fw-bold"><i class="fas fa-globe-americas me-2"></i> <span
                data-key="ds_explorar">Explorar Playlists</span></h2>
    </div>
    <p class="text-muted mb-4" data-key="explorar_desc">Descubre la música que otros usuarios de Soundverse están
        compartiendo. Copia sus listas públicas directamente a tus playlists.</p>

    <div class="row mb-4">
        <div class="col-md-6 col-lg-5">
            <div class="input-group shadow-sm">
                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fas fa-search"></i></span>
                <input type="text" id="buscador-explorar" class="form-control border-start-0"
                    placeholder="Buscar por nombre de playlist..." data-key="ds_buscar_ph">
                <button class="btn btn-primary" onclick="buscarPlaylists()"><span
                        data-key="ds_buscar">Buscar</span></button>
            </div>
        </div>
    </div>
...
<style>
    ...
    .playlist-card:hover {
        ...
        box-shadow: 0 10px 20px rgba(107, 70, 193, 0.2) !important;
    }
