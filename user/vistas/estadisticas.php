...
<div class="container-fluid pb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <h2 class="mb-0"><i class="fas fa-chart-line me-2 text-primary"></i> <span data-key="st_titulo">Mis
                    Estadísticas</span></h2>
    ...
    <div class="row g-3 mb-4" id="kpi-cards">
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center h-100"
                style="border-top: 4px solid #6B46C1 !important; border-radius:12px;">
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center h-100"
                style="border-top: 4px solid #38a169 !important; border-radius:12px;">
                <div class="card-body py-3">
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center h-100"
                style="border-top: 4px solid #d69e2e !important; border-radius:12px;">
                <div class="card-body py-3">
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm text-center h-100"
                style="border-top: 4px solid #0bc5ea !important; border-radius:12px;">
                <div class="card-body py-3">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-7">
            <div class="card border-0 shadow-sm h-100" style="border-radius:12px;">
                <div class="card-header bg-info text-white fw-bold d-flex justify-content-between align-items-center flex-wrap gap-2"
                    style="border-radius:12px 12px 0 0;">
                    ...
                    <div class="btn-group btn-group-sm" role="group" id="filtro-artistas">
                        <button type="button" class="btn btn-light btn-artistas-filtro active"
                            data-filtro="mes_actual">Este mes</button>
                        <button type="button" class="btn btn-light btn-artistas-filtro" data-filtro="anio_actual">Este
                            año</button>
                        <button type="button" class="btn btn-light btn-artistas-filtro"
                            data-filtro="todo">Histórico</button>
                    </div>
                </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100"
                style="border-radius:12px; border-top: 4px solid #9f7aea !important;">
                <div class="card-header fw-bold"
                    style="background: #f5f0ff; border-radius:12px 12px 0 0; color:#6B46C1;">
                    <i class="fas fa-list-music me-2"></i> Mis Playlists Activas
                </div>
                <div class="card-body p-0" id="top-playlists">
                    <div class="text-center py-4">
                        <div class="spinner-border spinner-border-sm" style="color:#9f7aea"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius:12px;">
                <div class="card-header bg-gradient fw-bold text-white"
                    style="background: linear-gradient(135deg,#6B46C1,#3182ce); border-radius:12px 12px 0 0;">
                ...
                <div class="card-body">
                    <div id="chart-evolucion" style="width:100%; height:280px;">
                        <div class="text-center py-5">
                            ...
                            <p class="mt-2 text-muted small">Calculando evolución...</p>
                        </div>
                    </div>
                </div>
            </div>
